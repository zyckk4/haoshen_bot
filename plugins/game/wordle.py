...
class Wordle():
    ...
    def __init__(self,total_guess_chance=6,word_len=5,mode=1):
        ...
        self.w=word_len*self.cell_w+(word_len-1)*self.gap_w+self.left_empty+self.right_empty
        self.h=total_guess_chance*self.cell_h+(total_guess_chance-1)*self.gap_h+self.up_empty+self.down_empty
    ...
    def __draw_cell_bd(self,coord):
        ...
        draw.rectangle((self.left_empty+coord[0]*(self.cell_w+self.gap_w), 
                       ...
                       self.left_empty+coord[0]*(self.cell_w+self.gap_w)+self.cell_w,
        ...
        draw.rectangle((self.left_empty+coord[0]*(self.cell_w+self.gap_w)+self.cell_bd, 
                       self.up_empty+coord[1]*(self.cell_h+self.gap_h)+self.cell_bd, 
                       self.left_empty+coord[0]*(self.cell_w+self.gap_w)+self.cell_w-self.cell_bd,
