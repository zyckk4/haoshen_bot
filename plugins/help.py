...
4./纯几何吧,/纯几何吧人,/纯几何吧签+内容以搜索纯几何吧的帖子.输入//+链接名可以追加点击图中的一个链接.(也可以"/直接搜"+内容)
5./latex+LaTeX代码可以生成LaTeX图片
6.多项式功能./hm+多项式生成热图，/tri+多项式生成系数阵
7.在线编程功能.输入/R','/vb','/ts','/kt','/pas', /lua','/node.js','/go','/swift','/rs','/sh','/pl','/erl', /scala','/cs','/rb','/cpp','/c','/java','/py3','/py','/php'以开始.
